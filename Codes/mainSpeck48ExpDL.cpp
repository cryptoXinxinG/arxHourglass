...
#if 0 //verify 6DL for our new 12-round DL 
	int start = 2, end = 8;
	int round = end - start;
	uint8_t oneInDiffIdx[1] = { 15 };
	uint8_t oneOutMaskIdx[1] = { 2 + 24 };
	string fileName = "Speck48 " + to_string(round) + "DL, verify [15][] to [][2].txt";
	getSpeck48ExpDlCorGiven1Diff1MaskIdx(fileName, oneInDiffIdx, 1, oneOutMaskIdx, 1, start, end, pow(2, 32), 50);
#endif

#if 1 //verify 6DL for our new 12-round DL 
	int start = 2, end = 8;
	int round = end - start;
	uint8_t oneInDiffIdx[1] = { 7 };
	uint8_t oneOutMaskIdx[1] = { 5 + 24 };
	string fileName = "Speck48 " + to_string(round) + "DL, verify [7][] to [][5].txt";
	getSpeck48ExpDlCorGiven1Diff1MaskIdx(fileName, oneInDiffIdx, 1, oneOutMaskIdx, 1, start, end, pow(2, 32), 50);
#endif

#if 0 //verify 6DL for 11-round in both [30] and [41] 
	int start = 2, end = 8;
	int round = end - start;
	uint8_t oneInDiffIdx[1] = { 15 };
	uint8_t oneOutMaskIdx[1] = { 5 + 24 };
